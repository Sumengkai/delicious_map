...
public enum StoreFood_RtnCode {
	...
	CANT_FIND_price("400","price Can't<=0 or null"), // api 2
	...
	CANT_FIND_LIST("400"," There are no store in this city or Number Can't <0"), // api 3 
	CANT_FIND_POINTLIST("400","Point Can't > 5 or null or too demanding"), //  api 4 and 5
